...
public class ManualActivity extends Activity implements View.OnClickListener {
    ...
    private final CameraDevice.StateCallback stateCallback = new CameraDevice.StateCallback() {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ManualActivity.this.cameraDevice = cameraDevice;
            // 开始预览
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            cameraDevice.close();
            ManualActivity.this.cameraDevice = null;
        }
        ...
        try
        {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface
                    , imageReader.getSurface()), new CameraCaptureSession.StateCallback() // ③
                    {
                        ...
                        {
                            Toast.makeText(ManualActivity.this, "配置失败！"
                    ...
                    new ImageReader.OnImageAvailableListener()
                    {
                        ...
                        public void onImageAvailable(ImageReader reader)
                        {
                           ...
                           // File file1 = new File("/mnt/sdcard/Pictures",getImageName()+".jpg");
                            ...
                            {
                                output.write(bytes);
                                Toast.makeText(ManualActivity.this, "保存: "
